...
class Text_Editor():
    def __init__(self):
        ...
        self.main_ui.colorTextButt.setIcon(QtGui.QIcon(os.path.join(projDir, "tests", "image_files", "color_text.svg")))
        self.main_ui.colorBgButt.setIcon(QtGui.QIcon(os.path.join(projDir, "tests", "image_files", "color_bg.svg")))
        ...
        self.main_ui.colorTextButt.clicked.connect(self.set_text_color)
        self.main_ui.colorBgButt.clicked.connect(self.set_bg_color)
    ...
    def set_text_color(self):
        color = QColorDialog.getColor(parent=self.main_ui)
